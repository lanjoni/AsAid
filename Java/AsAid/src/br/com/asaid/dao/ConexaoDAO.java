...
public class ConexaoDAO {
    ...
    public static void ConectDB() {
        try {
            ...
            String dsn = "AsAidbanco"; //nome do banco de dados(igual ao criado no Postgres)
            String user = "postgres"; //nome do usuario utilizado para se conectar
            String senha = "pgserver"; //senha do usuario acima informado Maquina João
            //String senha = "postdba"; //senha do usuario maquina Gobbi
